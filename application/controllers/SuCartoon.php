...
class SuCartoon extends CI_Controller {
    ...
    public function FileDel(){
        ...
        if(ArrayCount($Rs)>0){
            ...
            $log = 'Scene_Total_Delete|'.$pcode.'_'.$cnum;
            $bool = fn_Log($this,$log);
            echo('total='.$i);
    ...
    public function View()
    {
        ...
        if(empty($ccode)){
            ...
            $Rs = $this->cartoon_m->Admin_Load($uid,$ccode);
            if($Rs[0]['Cnt'] <=0){
                alert('잘못된 접근입니다.');
            }else {
                ...
                if (empty($Rs)) {
                    ...
                    $this->load->view(CMS_VIEW_ROOT . 'sub2_cartoon_View', $data);
    ...
    public function Data_Load(){
        ...
        if (!empty($query)) {
            ...
            foreach ($query->result() as $row) {
                ...
                $row->isActive == 0 ? $rdate ='' : $rdate = $row->regidate;
    ...
    public function Scene(){
        ...
        if(empty($pcode) || empty($cnum)){
            ...
            $this->load->view(CMS_VIEW_ROOT.'include/header_View.php',$hearder_Data);
            $this->load->view(CMS_VIEW_ROOT.'scene2_View.php',$data);
    ...
    function upload_Scene_img(){
        ...
        if ($sn === null || $key=== null || $pcode === null || $cnum=== null) {
            ...
            $uptempPass = '/www/inamutoon_com/assets/data/cartoon_scene1/temp';
