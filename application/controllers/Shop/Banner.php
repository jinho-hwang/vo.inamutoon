...
class Banner extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view(SHOP_VIEW_ROOT . 'banner_View');
    ...
    public function Data_Load()
    {
        ...
        $this->load->model(SHOP_MODEL_ROOT . 'banner_m');
        ...
        if (!empty($query)) {
            ...
            foreach ($query->result() as $row) {
                ...
                $response->rows[$i]['cell'] = array(
                    $row->sn, $row->imgname, $row->Described, $row->mtype, $row->URL,$row->bgcolor, $row->isNum,$row->isOpen, $row->imgname,$row->regidate
                );
                $i++;
            }
        }
    ...
    public function Advert(){
        ...
        $this->load->view(CMS_VIEW_ROOT . 'include/header_View', $hearder_Data);
        $this->load->view(SHOP_VIEW_ROOT . 'ad_banner_View');
        $this->load->view(CMS_VIEW_ROOT . 'include/footer_View');
    ...
    public function AdData_Load()
    {
        ...
        if (!empty($query)) {
            ...
            foreach ($query->result() as $row) {
                $response->rows[$i]['id'] = $row->sn;
                $response->rows[$i]['cell'] = array(
                    $row->sn, $row->fname, $row->title, $row->location, $row->Link, $row->bgcolor,$row->isUse, $row->fname,$row->regidate
                );
                $i++;
            }
        }
