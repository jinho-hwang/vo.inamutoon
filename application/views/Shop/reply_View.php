                ...
                <?foreach($list as $value){?>
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <? echo($value['regidate']);?> - <a href="<?echo(SHOP_ROOT_URL);?>Answer/Reply_del/<? echo($value['sn']);?>">삭제</a>
                        </div>
                        <div class="panel-body">
                            <p class="help-block"><? echo($value['comment']);?></p>
                        </div>
                    </div>
                <?}?>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <form name="reply" id="reply" method="post" action="<?echo(SHOP_ROOT_URL);?>Answer/Reply_do">
                                    <input type="hidden" value="<? echo($sn);?>" id="qsn" name="qsn" />
                                    <div class="form-group">
                                        <label>답변작성</label>
