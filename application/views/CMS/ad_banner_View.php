    ...
    $(function(){
        ...
        var uploadFile = function(response, postdata) {
            ...
            if (returnData.result) {
                ...
                $.ajaxFileUpload({
                    url: '<?echo(CONTENT_ROOT);?>/Cartoon/upload_banner_img3/',
                    secureuri: false,
        ...
        $(function(){
            $("#list").jqGrid({
                mtype:"POST",
                url: '<?echo(ROOT_URL);?>Banner/AdData_Load',
                editurl: '<?echo(ROOT_URL);?>Banner/AdData_Update',
                datatype: "json",
                loadonce: false,
                ...
                colModel:[
                    ...
                    {name: 'location', index: 'location', align: 'center', sortable: false, editable: true, search: false, edittype: 'select', editoptions: {value: {'0':'선택','1':'메인상단','2':'메인중앙','3':'웹툰상세오른쪽','4':'모바일뷰어하단','5':'모바일메인중앙'}},formatter: 'select'},
            ...
            $("#list").jqGrid('navGrid', '#pager', {
                ...
                closeAfterAdd: true,
                closeOnEscape: true,
                url: '<?echo(ROOT_URL);?>Banner/AdData_Add',
                afterSubmit: uploadFile,
                ...
                closeOnEscape: true,
                url: '<?echo(ROOT_URL);?>Banner/AdData_Del',
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">일반광고배너관리</h1><div align="right"><input type="button" value="초기화"  onclick="javascrip:ini_Data();" /></div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
