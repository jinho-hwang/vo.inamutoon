...
<head>
    ...
    <script type="text/javascript" src="<?echo(ASSETS_ROOT);?>/js/highchecktree.js"></script>
    <link rel="stylesheet" type="text/css" href="<?echo(ASSETS_ROOT);?>/css/highCheckTree.css"/>
