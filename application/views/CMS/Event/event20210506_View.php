<script>
    ...
    $(function(){
        $("#list").jqGrid({
            mtype:'POST',
            url: '<?echo(ROOT_URL);?>Event/e20210506_Load',
            datatype: "json",
            loadonce: false,
...
<script type="text/javascript">
    function ini_Data(){
        $(location).attr('href',"<?echo(ROOT_URL);?>Event/e20210506")
    }
</script>
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">북키퍼 책 증정 이벤트</h1><div align="right"><input type="button" value="Reset"  onclick="javascrip:ini_Data();" /></div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
