<script>
    ...
    $(function(){
        $("#list").jqGrid({
            mtype:'POST',
            url: '<?echo(ROOT_URL);?>Event/open1_Data_Load',
            datatype: "json",
            loadonce: false,
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">공룡대발이 선물대방출</h1><div align="right"><input type="button" value="Reset"  onclick="javascrip:ini_Data();" /></div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
