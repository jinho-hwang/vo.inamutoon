...
<script>
    $(document).ready(function(){
        $('#search').click(function(){
            location.href = '<?echo(ROOT_URL);?>Event/ToonView2/' + $('#year').val() + '/' + $('#month').val();
        });
    });
</script>
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">고양-EBSTOON 공모전 - 투표현황</h1>
    ...
    <div>
        <div class="panel panel-default">
            <div class="panel-heading">
                고양-EBSTOON 공모전 투표현황 ( 총 투표수 : <?echo(number_format($Total));?> 건)
            </div>
            <!-- /.panel-heading -->
