<script>
    ...
    $(function(){
        $("#list").jqGrid({
            mtype:'POST',
            url: '<?echo(ROOT_URL);?>Event/m20200901_Data_Load',
            datatype: "json",
            loadonce: false,
            colNames:['아이디','이름','SNS','참가 일자'],
            height: 250,
            colModel:[
                ...
                {name:'url',index:'address', width:300, align: 'center', editable: true, editrules: {required: true},search: true},
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">맛있는 한자 이벤트(총참여수 : <?echo($total);?>건)</h1><div align="right"><input type="button" value="Reset"  onclick="javascrip:ini_Data();" /></div>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
