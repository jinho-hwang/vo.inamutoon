<script>
    $(function(){
        ...
        $(function(){
            $("#list").jqGrid({
                mtype:"POST",
                url: '<?echo(ROOT_URL);?>SuCartoon/Data_Load',
                editurl: '<?echo(ROOT_URL);?>SuCartoon/Data_Update/<?echo($ccode);?>',
                datatype: "json",
                ...
                colModel:[
                    ...
                    {name: 'sType', index: 'sType', align: 'center', sortable: false, editable: true, editrules: {required: true}, stype: 'select', searchoptions: {value: {'0':'연재','1':'프롤로그','2':'휴재','3':'인터뷰','4':'특별편'}}, edittype: 'select',
                        editoptions: {
                            value: {'0':'연재','1':'프롤로그','2':'휴재','3':'인터뷰','4':'특별편'},
                        }, formatter: 'select',search: true},
            ...
            $("#list").jqGrid('navGrid', '#pager', {
                ...
                closeAfterAdd: true,
                closeOnEscape: true,
                url: '<?echo(ROOT_URL);?>SuCartoon/Data_Add/<?echo($ccode);?>',
                afterSubmit: uploadFile,
                ...
                closeOnEscape: true,
                url: '<?echo(ROOT_URL);?>SuCartoon/Data_Delete/<?echo($ccode);?>',
    ...
    function View_Scene(val1,val2){
        var URL = "<?echo(ROOT_URL);?>SuCartoon/Scene/" + val1 + "/" + val2;

        location.href = URL;
    }

    function free_View(val1,val2){
        var URL = "<?echo(ROOT_URL);?>SuCartoon/fView/" + val1 + "/" + val2;
